...
print(50 * '=')
print('Section: Training a perceptron model on the Calificaciones dataset')
print(50 * '-')
## AQUÍ VAN A TOMAR SUS DATOS DEL PROGRAMA ANTERIOR ##
df = pd.read_csv('datos.csv', header=0, encoding='ISO-8859-1')
print(df.tail())

#############################################################################
print(50 * '=')
print('Plotting calificaciones data')
print(50 * '-')


y = df.iloc[0:100, 4].values
y = np.where(y == 'calificaciones', -1, 1)
...
plt.scatter(X[:5, 0], X[:5, 1],
            color='red', marker='o', label='Mujer')
plt.scatter(X[5:10, 0], X[5:10, 1],
            color='blue', marker='x', label='Hombre')
